...
You have entered another dungeon. You are standing at the bottom of the staircase where you entered, facing east. You pick up a purse of stacking that someone has left on the staircase. The purse has plenty of room for a tall stack of numbers. Adding a number onto the top of the stack is called pushing, while removing a number from the top of the stack is called popping. You start each dungeon exploration with an empty stack. After strapping the purse to your belt, you turn your attention to the map:
